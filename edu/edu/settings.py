...
DATABASES = {
    'default': {
        ...
        'NAME': 'edu',                      # Or path to database file if using sqlite3.
...
import os
STATIC_ROOT = os.path.dirname(__file__).decode('gbk')
...
SECRET_KEY = '3=ip%+4x*2$=_agnwxluh=g2+tg6@%ns2x+cra3p*eo*x_o7pw'
